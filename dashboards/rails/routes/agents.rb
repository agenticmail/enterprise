...
post '/agents/:id/deploy' do
  ...
  set_flash(res[:status] < 300 ? 'Agent deployed' : (res[:body].is_a?(Hash) ? res[:body]['error'] || 'Failed' : 'Failed'), res[:status] < 300 ? 'success' : 'danger')
...
post '/agents/:id/stop' do
  ...
  set_flash(res[:status] < 300 ? 'Agent stopped' : (res[:body].is_a?(Hash) ? res[:body]['error'] || 'Failed' : 'Failed'), res[:status] < 300 ? 'success' : 'danger')
  redirect "/agents/#{params[:id]}"
end
...
post '/agents/:id/restart' do
  ...
  set_flash(res[:status] < 300 ? 'Agent restarted' : (res[:body].is_a?(Hash) ? res[:body]['error'] || 'Failed' : 'Failed'), res[:status] < 300 ? 'success' : 'danger')
  redirect "/agents/#{params[:id]}"
end
...
post '/agents' do
  ...
  set_flash(res[:status] < 300 ? 'Agent created' : (res[:body]['error'] || 'Failed'), res[:status] < 300 ? 'success' : 'danger')
  redirect '/agents'
end
...
post '/agents/:id/tool-security' do
  ...
  set_flash(res[:status] < 300 ? 'Agent tool security updated' : (res[:body].is_a?(Hash) ? res[:body]['error'] || 'Failed' : 'Failed'), res[:status] < 300 ? 'success' : 'danger')
...
post '/agents/:id/archive' do
  ...
  set_flash(res[:status] < 300 ? 'Agent archived' : (res[:body]['error'] || 'Failed'), res[:status] < 300 ? 'success' : 'danger')
  redirect '/agents'
end

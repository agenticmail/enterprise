...
# API Client helpers (like Rails service object)
helpers do
  ...
  def api_get(path)    = api_request(:get, path)
  def api_post(path, body) = api_request(:post, path, body: body)
  def api_put(path, body) = api_request(:put, path, body: body)
  def api_patch(path, body) = api_request(:patch, path, body: body)
  def api_delete(path) = api_request(:delete, path)
end

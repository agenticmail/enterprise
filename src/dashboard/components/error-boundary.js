    ...
    if (this.state.error) {
      return h('div', { style: { minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg-primary)', color: 'var(--text-primary)', fontFamily: 'var(--font)' } },
        h('div', { style: { textAlign: 'center', maxWidth: 480, padding: 24 } },
          h('div', { style: { marginBottom: 16 }, dangerouslySetInnerHTML: { __html: '<svg width="48" height="48" viewBox="0 0 24 24" fill="none"><path d="M12 2L1 21h22L12 2z" fill="rgba(234,179,8,0.2)" stroke="#eab308" stroke-width="1.5"/><path d="M12 9v4M12 16h.01" stroke="#eab308" stroke-width="2" stroke-linecap="round"/></svg>' } }),

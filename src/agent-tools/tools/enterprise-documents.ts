...
export function createDocumentTools(options?: ToolCreationOptions): AnyAgentTool[] {
  ...
  var entDocGenerateDocx: AnyAgentTool = {
    ...
    label: 'Generate DOCX',
    description: 'Generate a Microsoft Word DOCX document from plain text content.',
    category: 'file',
    risk: 'medium',
    parameters: {
      type: 'object',
  ...
  var entDocParseInvoice: AnyAgentTool = {
    ...
    label: 'Parse Invoice',
    description: 'Parse structured text to extract invoice fields: invoice number, date, vendor...',
    category: 'utility',
    risk: 'low',
    parameters: {
      type: 'object',
  ...
  var entDocConvert: AnyAgentTool = {
    ...
    description: 'Convert between document formats: markdown to HTML, HTML to plain text, JSON ...',
    category: 'utility',
    risk: 'medium',
    parameters: {
      type: 'object',
  ...
  var entDocExtractTables: AnyAgentTool = {
    ...
    description: 'Extract tabular data from HTML files (HTML tables) or text files (aligned col...',
    category: 'utility',
    risk: 'low',
    parameters: {
      type: 'object',
  ...
  var entDocMergePdfs: AnyAgentTool = {
    ...
    label: 'Merge PDFs',
    description: 'Concatenate multiple PDF files into a single PDF.',
    category: 'file',
    risk: 'medium',
    parameters: {
      type: 'object',
  ...
  var entDocFillForm: AnyAgentTool = {
    ...
    description: 'Replace {{placeholder}} patterns in a document template with provided values.',
    category: 'file',
    risk: 'medium',
    parameters: {
      type: 'object',
      properties: {
        ...
        values: { type: 'string', description: 'JSON object of placeholder names to values (e.g., {"name": "John", "date": "2...' },
      },

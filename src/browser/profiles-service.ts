...
import { resolveAgenticMailUserDataDir } from "./chrome.js";
...
import type { BrowserProfileConfig, AgenticMailConfig } from "./enterprise-compat.js";
...
export function createBrowserProfilesService(ctx: BrowserRouteContext) {
  ...
  const createProfile = async (params: CreateProfileParams): Promise<CreateProfileResult> => {
    ...
    const nextConfig: AgenticMailConfig = {
      ...cfg,
      browser: {
        ...cfg.browser,
        profiles: {

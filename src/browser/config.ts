...
import type { BrowserConfig, BrowserProfileConfig, AgenticMailConfig, SsrFPolicy } from "./enterprise-compat.js";
...
/**
 * Ensure the default "agenticmail" profile exists in the profiles map.
 ...
 *
 * Note: this is an AgenticMail browser profile (routing config), not a Chrome user profile.
...
function ensureDefaultChromeExtensionProfile(
  ...
  // (legacy single-profile configs may use controlPort+1 for agenticmail/agenticmail CDP).
